...
function FilterWrapper(props) {
	...
	const removeFilterField = useStore(({ removeFilterField }) => removeFilterField);
	const resetFilterFields = useStore(({ resetFilterFields }) => resetFilterFields);
			...
			<div className={"card flexv overflow-y--auto"}>
				<div style={{ width: "100%" }} className="flexv">
					<Space className="sticky" size="middle">
						...
						{props.seeResultBtn ? <ResultButton fetchFiltered={FilterUserFetch} /> : null}
